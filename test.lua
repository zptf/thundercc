...
function Library:AddToolTip(InfoStr, HoverInstance)
    local X, Y = Library:GetTextBounds(InfoStr, Enum.Font.RobotoMono, 14);
...
do
    ...
    function Funcs:AddLabel(Text, DoesWrap)
        ...
        if DoesWrap then
            local Y = select(2, Library:GetTextBounds(Text, Enum.Font.RobotoMono, 14, Vector2.new(TextLabel.AbsoluteSize.X, math.huge)))
...
function Library:SetWatermark(Text)
    local X, Y = Library:GetTextBounds(Text, Enum.Font.RobotoMono, 14);
...
function Library:Notify(Text, Time)
    local XSize, YSize = Library:GetTextBounds(Text, Enum.Font.RobotoMono, 14);
