...
Options.wrl_skyboxtype:OnChanged(function()
    if Toggles.wrl_skyboxenabled.Value == true then
        local thundersky = lighting:FindFirstChild("thundersky") or Instance.new("Sky")
        thundersky.Parent = game.Lighting
        thundersky.Name = "thundersky"
        thundersky.SkyboxBk = SkyboxesTable[Options.wrl_skyboxtype.Value].SkyboxBk
        thundersky.SkyboxDn = SkyboxesTable[Options.wrl_skyboxtype.Value].SkyboxDn
        thundersky.SkyboxFt = SkyboxesTable[Options.wrl_skyboxtype.Value].SkyboxFt
        thundersky.SkyboxLf = SkyboxesTable[Options.wrl_skyboxtype.Value].SkyboxLf
        thundersky.SkyboxRt = SkyboxesTable[Options.wrl_skyboxtype.Value].SkyboxRt
        thundersky.SkyboxUp = SkyboxesTable[Options.wrl_skyboxtype.Value].SkyboxUp
    else
        if game.Lighting:FindFirstChild("thundersky") then
            game.Lighting.thundersky:Destroy()
        end
    end
end)
...
ThemeManager:SetFolder('thunder.cc')
SaveManager:SetFolder('thunder.cc/main')
...
OthersSettings:AddInput('uinamechange', {Default = 'thunder.cc', Numeric = false, Finished = false, Text = 'Window Title', Tooltip = 'Changes window title', Placeholder = '. . .'})
...
Library:Notify('Finished Loading! Welcome ' ..localPlayer.Name.. ' to thunder.cc!');
